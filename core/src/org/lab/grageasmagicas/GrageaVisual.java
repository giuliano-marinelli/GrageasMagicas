...
public class GrageaVisual{
    ...
    public void cargarImageButtonStyle(){
        ...
        gragea0ButtonStyle.up = new
                TextureRegionDrawable(new TextureRegion(gragea0Texture));
        gragea0ButtonStyle.down = new
                TextureRegionDrawable(new TextureRegion(gragea0TextureSeleccionada));
        gragea0ButtonStyle.checked = new
                TextureRegionDrawable(new TextureRegion(gragea0TextureSeleccionadaDoble));

       gragea0Style =new ImageButton.ImageButtonStyle(gragea0ButtonStyle);
        gragea0Style.imageDisabled=new
                TextureRegionDrawable(new TextureRegion(gragea0Texture));



        Button.ButtonStyle gragea1ButtonStyle = new Button.ButtonStyle();
        gragea1ButtonStyle.up = new
                TextureRegionDrawable(new TextureRegion(gragea1Texture));
        gragea1ButtonStyle.down = new
                TextureRegionDrawable(new TextureRegion(gragea1TextureSeleccionada));
        gragea1ButtonStyle.checked = new
                TextureRegionDrawable(new TextureRegion(gragea1TextureSeleccionadaDoble));

        gragea1Style =new ImageButton.ImageButtonStyle(gragea1ButtonStyle);
        gragea1Style.imageDisabled=new
                TextureRegionDrawable(new TextureRegion(gragea1Texture));


        Button.ButtonStyle gragea2ButtonStyle = new Button.ButtonStyle();
        gragea2ButtonStyle.up = new
                TextureRegionDrawable(new TextureRegion(gragea2Texture));
        gragea2ButtonStyle.down = new
                TextureRegionDrawable(new TextureRegion(gragea2TextureSeleccionada));
        gragea2ButtonStyle.checked = new
                TextureRegionDrawable(new TextureRegion(gragea2TextureSeleccionadaDoble));

        gragea2Style =new ImageButton.ImageButtonStyle(gragea2ButtonStyle);
        gragea2Style.imageDisabled=new
                TextureRegionDrawable(new TextureRegion(gragea2Texture));


        Button.ButtonStyle gragea3ButtonStyle = new Button.ButtonStyle();
        gragea3ButtonStyle.up = new
                TextureRegionDrawable(new TextureRegion(gragea3Texture));
        gragea3ButtonStyle.down = new
                TextureRegionDrawable(new TextureRegion(gragea3TextureSeleccionada));
        gragea3ButtonStyle.checked = new
                TextureRegionDrawable(new TextureRegion(gragea3TextureSeleccionadaDoble));

        gragea3Style =new ImageButton.ImageButtonStyle(gragea1ButtonStyle);
        gragea3Style.imageDisabled=new
                TextureRegionDrawable(new TextureRegion(gragea3Texture));


        Button.ButtonStyle gragea4ButtonStyle = new Button.ButtonStyle();
        gragea4ButtonStyle.up = new
                TextureRegionDrawable(new TextureRegion(gragea4Texture));
        gragea4ButtonStyle.down = new
                TextureRegionDrawable(new TextureRegion(gragea4TextureSeleccionada));
        gragea4ButtonStyle.checked = new
                TextureRegionDrawable(new TextureRegion(gragea4TextureSeleccionadaDoble));

        gragea4Style =new ImageButton.ImageButtonStyle(gragea4ButtonStyle);
        gragea4Style.imageDisabled=new
                TextureRegionDrawable(new TextureRegion(gragea4Texture));
